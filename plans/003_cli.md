...
- **Phase 4**: Enhanced REPL Configuration (custom prompts, trace/debug startup, colors) - OPTIONAL
- **Phase 5**: Advanced Features (script arguments, profiling, debug integration) - OPTIONAL
...
Note: Script arguments are passed directly after the script filename.
Example: viro script.viro arg1 arg2 arg3
```
...
#### T4.2: Trace/Debug Startup Modes (Days 3-4) ⏸️ NOT IMPLEMENTED
...
#### T4.3: Color Output (Day 5) ⏸️ NOT IMPLEMENTED
...
viro script.viro --verbose --debug --output file.txt
...
#### T5.3: Debug/Trace Integration ⏸️ NOT IMPLEMENTED
...
5. **Phase 5, T5.2-T5.3: Profiling/Debug** - Power user features
