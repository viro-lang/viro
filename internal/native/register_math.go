...
integers, decimals, strings, blocks, and objects. Returns true if values differ.`,
	...
	registerAndBind("and", value.NewNativeFunction(
		"and",
		[]value.ParamSpec{
			value.NewParamSpec("left", true),
			value.NewParamSpec("right", true),
...
and non-empty string is considered true; zero, empty strings, and false are considered false.`,
	...
	registerAndBind("or", value.NewNativeFunction(
		"or",
		[]value.ParamSpec{
			value.NewParamSpec("left", true),
			value.NewParamSpec("right", true),
...
and non-empty string is considered true; zero, empty strings, and false are considered false.`,
	...
	registerAndBind("not", value.NewNativeFunction(
		"not",
		[]value.ParamSpec{
...
In viro, any non-zero integer and non-empty string is considered true; zero, empty strings, and false are considered false.`,
	...
	registerAndBind("decimal", value.NewNativeFunction(
		"decimal",
		[]value.ParamSpec{
			value.NewParamSpec("value", true),
		},
...
Useful for financial calculations and when standard floating-point arithmetic is insufficient.`,
	...
	registerAndBind("pow", value.NewNativeFunction(
		"pow",
		[]value.ParamSpec{
...
Always returns a decimal for precision. Supports negative exponents for fractional results.`,
	...
	registerAndBind("sqrt", value.NewNativeFunction(
		"sqrt",
		[]value.ParamSpec{
			value.NewParamSpec("value", true),
		},
...
Raises an error if the input is negative.`,
	...
	registerAndBind("exp", value.NewNativeFunction(
		"exp",
		[]value.ParamSpec{
			value.NewParamSpec("exponent", true),
		},
...
Useful for exponential growth calculations and mathematical analysis.`,
	...
	registerAndBind("log", value.NewNativeFunction(
		"log",
		[]value.ParamSpec{
			value.NewParamSpec("value", true),
		},
...
The input must be positive. This is the inverse of the exp function.`,
	...
	registerAndBind("log-10", value.NewNativeFunction(
		"log-10",
		[]value.ParamSpec{
			value.NewParamSpec("value", true),
		},
...
Useful for scientific calculations and order-of-magnitude estimations.`,
	...
	registerAndBind("sin", value.NewNativeFunction(
		"sin",
		[]value.ParamSpec{
...
Use multiplication by pi/180 to convert from degrees to radians.`,
	...
	registerAndBind("cos", value.NewNativeFunction(
		"cos",
		[]value.ParamSpec{
			value.NewParamSpec("angle", true),
		},
...
Use multiplication by pi/180 to convert from degrees to radians.`,
	...
	registerAndBind("tan", value.NewNativeFunction(
		"tan",
		[]value.ParamSpec{
			value.NewParamSpec("angle", true),
		},
...
Use multiplication by pi/180 to convert from degrees to radians.`,
	...
	registerAndBind("asin", value.NewNativeFunction(
		"asin",
		[]value.ParamSpec{
			value.NewParamSpec("value", true),
		},
...
The input must be between -1 and 1 (inclusive). Result is in range [-pi/2, pi/2].`,
	...
	registerAndBind("acos", value.NewNativeFunction(
		"acos",
		[]value.ParamSpec{
			value.NewParamSpec("value", true),
		},
...
The input must be between -1 and 1 (inclusive). Result is in range [0, pi].`,
	...
	registerAndBind("atan", value.NewNativeFunction(
		"atan",
		[]value.ParamSpec{
			value.NewParamSpec("value", true),
		},
...
Accepts any real number as input. Result is in range (-pi/2, pi/2).`,
	...
	registerAndBind("round", value.NewNativeFunction(
		"round",
		[]value.ParamSpec{
			value.NewParamSpec("value", true),
		},
...
(0.5 rounds up). Returns an integer value.`,
	...
	registerAndBind("ceil", value.NewNativeFunction(
		"ceil",
		[]value.ParamSpec{
			value.NewParamSpec("value", true),
		},
...
Always rounds upward, even for negative numbers.`,
	...
	registerAndBind("floor", value.NewNativeFunction(
		"floor",
		[]value.ParamSpec{
			value.NewParamSpec("value", true),
		},
...
Always rounds downward, even for negative numbers.`,
	...
	registerAndBind("truncate", value.NewNativeFunction(
		"truncate",
		[]value.ParamSpec{
			value.NewParamSpec("value", true),
		},
