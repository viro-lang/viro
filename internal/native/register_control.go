	...
	registerAndBind("foreach", value.NewNativeFunction(
		...
		&NativeDoc{
			...
			Examples: []string{
				...
				"obj: object [a: 1 b: 2]\nforeach obj [k] [print k]  ; prints: a b",
				"foreach obj [key value] [print [key value]]  ; prints: [a 1] [b 2]",
			},
